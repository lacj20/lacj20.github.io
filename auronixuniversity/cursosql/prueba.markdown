...
<div style="background:#ebf3fc;padding:1em;border-radius:10px;text-align:justify;box-shadow:0px 0px 5px gray;position:relative;padding-left:45px;">
<img src="imagenes/idea.svg" style="width:40px;position:absolute;left:4px;top:4px;">
